class Loader {
  constructor() {
    ...
    this.scrollBtnCircleArrow = document.querySelector('[data-scroll-arrow]');
  ...
  animateLoader() {
    ...
    this.loaderTl.fromTo(this.scrollBtnCircleArrow, 0.4, { y: -100 }, { y: 0, ease: Power2.easeOut }, "-=0.8");
